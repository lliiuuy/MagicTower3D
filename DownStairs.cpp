...
bool DownStairs::loadTexture()
{
	...
	char fileName[100];
	sprintf_s(fileName, "Data/Obstacle/DownStairs.bmp");
...
DownStairs::DownStairs(Vector2* positionInMap) : Obstacle(positionInMap)
{
	this->name = "DownStairs";
	this->tag = Tag::downStairs;
	this->spinY = 0;
}

void DownStairs::draw3D()
{
	glPushMatrix();
	glTranslatef(position->x, position->y - 3 * ly / 2 - ly / 20, position->z);
